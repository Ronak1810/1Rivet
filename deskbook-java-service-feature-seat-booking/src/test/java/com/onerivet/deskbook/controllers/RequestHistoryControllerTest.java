...
public class RequestHistoryControllerTest {
    ...
    public void testGetAllbyFirstNameandLastName() {
        ...
        when(requestHistoryService.searchByFirstNameOrLastName(name, sorting.createPageRequest()))
                .thenReturn(requestHistoryList);

       
        GenericResponse<List<RequestHistoryDto>> response = requestHistoryController.getAllbyFirstNameandLastName(name, sorting);
